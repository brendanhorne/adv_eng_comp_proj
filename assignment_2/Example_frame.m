...
elements = [% element ID, start node, end node, E, I, A
            1, 1, 2 290e6 0.055 0.16;
            2, 2, 3 290e6 0.028 0.12];
...
free_dofs = zeros((total_dof-size(fixed_dofs,1)),1)
free_dofs = reshape(all_dofs(~ismember(all_dofs,fixed_dofs)),size(free_dofs,1),1)
